...
TYPE_PRIMITIVE_ANY(sha1_clone)
TYPE_PRIMITIVE_ANY(sha1_add)
TYPE_PRIMITIVE_ANY(sha1_get)
TYPE_PRIMITIVE_ANY(blake2s_start)
TYPE_PRIMITIVE_ANY(blake2s_clone)
TYPE_PRIMITIVE_ANY(blake2s_add)
TYPE_PRIMITIVE_ANY(blake2s_get)
TYPE_PRIMITIVE_ANY(sha_start)
TYPE_PRIMITIVE_ANY(sha_clone)
TYPE_PRIMITIVE_ANY(sha_add)
TYPE_PRIMITIVE_ANY(sha_get)
TYPE_PRIMITIVE_ANY(siphash_start)
TYPE_PRIMITIVE_ANY(siphash_clone)
...
TYPE_PRIMITIVE_ANY(aead_init)
TYPE_PRIMITIVE_ANY(aead_close)
TYPE_PRIMITIVE_ANY(aead_start_message)
TYPE_PRIMITIVE_ANY(aead_add)
